...
public class NodeRegistryTest {
    ...
    void registerAndCreateTest(){
        ...
        Node logNode = nodeRegistry.create("node", "logNode", null);
    ...
    void checkCreateUnregisteredTypeCase(){
        ...
        Assertions.assertThrows(NodeRegistryException.class, ()->{
            nodeRegistry.create("node", "unknownType", null);
        });
    }
    ...
    void checkPassConfig(){
        ...
        Node protocolNode = nodeRegistry.create("node1", "protocolNode", config);
    ...
    void whenMethodCallParameterNullStringOrBlankString(){
        ...
        Assertions.assertAll(
                ()->Assertions.assertThrows(NodeRegistryException.class,
                        ()->{nodeRegistry.create("node1", "", Map.of());}),
                ()->Assertions.assertThrows(NodeRegistryException.class,
                    ()->{nodeRegistry.create("node2", null,Map.of());}),
                ()->Assertions.assertThrows(NodeRegistryException.class,
